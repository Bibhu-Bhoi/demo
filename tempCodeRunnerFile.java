...
public class EightPuzzle {
    ...
    static int[][] getUserInput() {
        ...
        System.out.println("Enter the initial state of the puzzle (3x3 matrix, use 0 for the empty tile):");
    ...
    static int[] findEmptyTile(int[][] state) {
    ...
    public static void main(String[] args) {
        ...
        int[] emptyTilePosition = findEmptyTile(initialState);
        int x = emptyTilePosition[0];
        int y = emptyTilePosition[1];
